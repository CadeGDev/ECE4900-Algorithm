...
# spectrogram_image_path = '/Users/cadeglauser/VSCose2Projects/ECE4900-Algorithm/project_root/Continuous/spectrogram4472.png'
...
# print(f'Predicted label: {predicted_label}') # or print the actual label if you have the mapping
